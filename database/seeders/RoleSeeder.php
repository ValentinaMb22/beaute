...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'admin.salas.index'])->syncRoles([$role1,$role2]);
        Permission::create(['name'=>'admin.salas.create'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name'=>'admin.citas.create'])->syncRoles([$role1,$role2]);
        Permission::create(['name'=>'admin.citas.edit'])->syncRoles([$role1,$role2]);
